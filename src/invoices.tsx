...
import { formatDisplayDate, parseDate } from "@/utils";

type InvoiceWithDisplayDate = InvoiceData & { displayDate: string };
...
const groupInvoicesByMonth = (
...
): Record<string, InvoiceWithDisplayDate[]> => {
  ...
  const groups = sortedInvoices.reduce(
    ...
    {} as Record<string, InvoiceWithDisplayDate[]>,
  );
...
export default function InvoiceListScreen() {
  ...
  const renderMonthSection = (
    month: string,
    invoices: InvoiceWithDisplayDate[],
  ) => (
    <View
      key={month}
