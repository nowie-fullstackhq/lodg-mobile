            ...
            <View style={styles.cardHeader}>
              ...
              <View style={styles.infoBox}>
                ...
                <Text style={styles.infoText}>
                  ...
                  access to your plan until the end of the current billing
                  cycle, after which it won't renew. For example, if your
                  subscription ends on September 30th and you cancel today,
                  you'll still have access until that date. In contrast, if you
                  terminate your subscription, all access to the service will
                  stop immediately, cutting off any features or benefits from
                  the moment you terminate, regardless of where you are in your
                  billing cycle.
                </Text>
              </View>
            </View>
